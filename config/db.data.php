 ...
 */
$arr_data = array (
	'pay' => array ('alipay'=>'支付宝','tenpay'=>'财富通','bank'=>'银行转帐','alipaydual'=>'支付宝双接口','alipayescow'=>'担保交易','adminpay'=>'管理员充值','balance'=>'余额支付','admincut'=>'管理员扣款'),
	'source' => array ('1'=>'网页','2'=>'手机','3'=>'App','4'=>'微信','5'=>'PC','6'=>'采集'),
	...
	'cache' => array ('1'=>"区域",'2'=>"行业",'3'=>"职位",'4'=>"个人会员分类",'5'=>"企业会员分类",'6'=>"导航",'7'=>"网站缓存",'8'=>"SEO设置",'9'=>"分站",'10'=>"关键字",'11'=>'友情链接','12'=>'新闻分类','13'=>'单页面分类','14'=>'广告'),
	'faceurl' => "/config/face/",
	...
	'datacall' => array(
		...
		'job'=>array("职位","order"=>array("id desc"=>"最新职位","hits desc"=>"热门职位","rec_time desc"=>"推荐职位","urgent_time desc"=>"紧急职位","lastedit desc"=>"更新时间"),"field"=>array("jobname"=>"职位名称","companyname"=>"公司名称","url"=>"职位链接","com_url"=>"公司链接","hy"=>"从事行业","hy_url"=>"行业链接","num"=>"招聘人数","jobtype"=>"职位类型","edu"=>"学历要求","age"=>"年龄要求","report"=>"到岗时间","exp"=>"工作经验","lang"=>"语言要求","salary"=>"提供月薪","welfare"=>"福利待遇","time"=>"有效日期","city"=>"工作地点")),
	...
	'seomodel'=>array("index"=>"首页","job"=>"找工作","com"=>"公司","resume"=>"找人才","news"=>"新闻","hr"=>"工具箱","zph"=>"招聘会","ask"=>"问答","evaluate"=>"测评","once"=>"微招聘","tiny"=>"微简历","gg"=>"公告","other"=>"其它"
	),
	'seoconfig'=>array(
		'public'=>array(
			'webname'=>"网站名称",
