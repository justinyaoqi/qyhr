...
<table width="100%" class="table_form">
  ...
  <tr class="admin_table_trbg">
	...
	<tr class="admin_table_trbg">
		...
		<td><input class="input-text tips_class" type="text" name="sy_once" id="sy_once" value="100" size="10" maxlength="255" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/> 次/天<font color="gray" style="display:none">提示：值为0时表示不限制次数</font></td>
         <td width="160">sy_once</td>
	</tr>
	<tr>
		<th width="220">同一IP点击广告记录间隔：</th>
		<td><input class="input-text tips_class" type="text" name="sy_adclick" id="sy_adclick" value="0" size="10" maxlength="255"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/> 小时<font color="gray" style="display:none">提示：值为0时表示不限制，其他数字为期限内只记录一次</font></td>
         <td width="160">sy_adclick</td>
	</tr>
	<tr class="admin_table_trbg">
		<th width="220">前台微简历发布次数：</th>
		<td><input class="input-text tips_class" type="text" name="sy_tiny" id="sy_tiny" value="2" size="10" maxlength="255" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/> 次/天<font color="gray" style="display:none">提示：值为0时表示不限制次数</font></td>
