...
class page
{
	...
	function setTpl()
	{
		...
		$numTpl['shenglue']='<em>...</em>';
			...
			$tpl['str']='[prestr][numstr][nextstr]<em>共[maxPage]页</em>';
		}
		if(!$this->notpl)
		{
			$this->numTpl=$numTpl;
...
.bt-confirm{background:#0371D3;border:none;color: #FFFFFF; cursor: pointer;height:25px; width: 48px;border-radius:3px; margin-left:3px;}</style>';
